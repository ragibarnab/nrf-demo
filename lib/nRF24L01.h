...
/* below are customized defines by rae0924,
change the CSN and CE to whatever pin you desire*/

// pin defines and macros
...
#define CSN PB2   
#define CE PB1   
#define SLAVE_DESELECT PORTB |= (1 << CSN)
#define SLAVE_SELECT PORTB &= ~(1 << CSN)
...
void nRF_ReceivePayload(uint8_t payload[], uint8_t size);
